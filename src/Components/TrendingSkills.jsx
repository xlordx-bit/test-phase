...
export default function TrendingSkills() {
  return (
    <section className="py-24 px-6 bg-gradient-to-tr from-[#0a0a14] to-[#1a1a2e] text-white">
      ...
      <div className="flex space-x-8 overflow-visible py-12 px-4 scroll-smooth snap-x snap-mandatory scrollbar-thin scrollbar-thumb-yellow-500 scrollbar-track-gray-800">
        {skills.map((skill, index) => (
          <div className="min-w-[260px] py-4" key={index}>
            <motion.div
              whileHover={{
                scale: 1.1,
                boxShadow: "0 12px 25px rgba(255, 215, 75, 0.6)",
                zIndex: 10,
              }}
              transition={{ type: "spring", stiffness: 300 }}
              className={`bg-gradient-to-br ${skill.color} rounded-3xl p-8 shadow-2xl flex flex-col items-center text-center select-none`}
            >
